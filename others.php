...
if(isset($_POST["submit"]))
{
	   ...
	   $tmp_image=$_FILES['image']['tmp_name'];
		 ...
		 VALUES (NULL, CURRENT_TIMESTAMP, '$use', 'others', '$post','$image', '1', 'pending');";
...
$connect=mysqli_connect($dbhost,$dbuser,$dbpassword,$dbname);	
	   ...
	   $qry="SELECT *
	      FROM users,save WHERE users.username=save.username and status='approve' and category='others' ORDER BY views DESC";
