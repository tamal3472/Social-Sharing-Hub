            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="comment-box">
                        <div class="row">
                            <div class="col-xs-12">
                            <form action="jt.php" method="post"   enctype="multipart/form-data">
...
$connect=mysqli_connect($dbhost,$dbuser,$dbpassword,$dbname);	
	   ...
	   $qry="SELECT *
	      FROM users,save WHERE users.username=save.username and status='approve' and category='journal'  ORDER BY views DESC";
